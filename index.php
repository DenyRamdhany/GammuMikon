      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            <li class="active"><a href="#">Ethernet</a></li>
			<li class=""><a href="sms.php">SMS</a></li>
          </ul>
			...
			while($data=mysql_fetch_object($qry))
				 { echo "<tr>";
				   ...
				   echo "<td align=center>
							<button class=btn-warning onclick='kirim(\"$data->NoRek\",\"0\",\"1\")'>Notifikasi</button>&nbsp;";
						if($data->status=='0')
							echo "<button class=btn-success onClick='controll(\"$data->NoRek\",\"0\",\"1\")'>Turn On</button>";
						else echo "<button class='btn-danger' onClick='controll(\"$data->NoRek\",\"0\",\"0\")'>Turn Off</button>";
				   echo "<br><br>
							 <button class=btn-primary onclick='kirim(\"$data->NoRek\",\"0\",\"2\")'>Warning</button>  
						     <button class=btn-primary onclick='kirim(\"$data->NoRek\",\"0\",\"3\")'>SP-1</button> 
							 <button class=btn-primary onclick='kirim(\"$data->NoRek\",\"0\",\"4\")'>SP-2</button>";
				   echo "</td></tr>"; 
				 }
			?>
		</tbody>
